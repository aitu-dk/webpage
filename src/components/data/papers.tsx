...
const papers = [
    ...
    new Paper("Intriguing Properties of Contrastive Losses", ["Ting Chen", "Calvin Luo", "Lala Li"], "https://arxiv.org/abs/2011.02803", "public/posts/images/Intriguing Properties of Contrastive Losses.png", new Date(2024, 3, 23)),
    ...
    new Paper("Emerging Properties in Self-Supervised Vision Transformers (DINO)", ["Mathilde Caron", "Hugo Touvron", "Ishan Misra", "Hervé Jégou", "Julien Mairal", "Piotr Bojanowski", "Armand Joulin"], "https://arxiv.org/pdf/2104.14294.pdf", "posts/images/Emerging Properties in Self-Supervised Vision Transformers.png", new Date(2024, 3, 30)),
    ...
    new Paper("Self-Supervised Learning from Images with a Joint-Embedding Predictive Architecture (I-JEPA)", ["Mahmoud Assran", "Quentin Duval", "Ishan Misra", "Piotr Bojanowski", "Pascal Vincent", "Michael Rabbat", "Yann LeCun", "Nicolas Ballas"], "https://arxiv.org/pdf/2301.08243.pdf", "posts/images/Self-Supervised Learning from Images with a Joint-Embedding Predictive Architecture.png", new Date(2024, 4, 14)),
    ...
    new Paper("SGD", ["appliedprobability"], "https://appliedprobability.wordpress.com/2024/05/12/sgd/", "posts/images/SGD.png", new Date(2024, 4, 28)),

    new Paper("Adding Gradient Noise Improves Learning for Very Deep Networks", ["Arvind Neelakantan", "Luke Vilnis", "Quoc V. Le", "Ilya Sutskever", "Lukasz Kaiser", "Karol Kurach", "James Martens"], "https://arxiv.org/pdf/1511.06807.pdf", "public/posts/images/Added Gradient Noise.png", new Date(2024, 5, 11)),
    ...
    new Paper("Neural Networks for Machine Learning", ["Geoffrey Hinton", "Nitish Srivastava", "Kevin Swersky"], "https://www.cs.toronto.edu/~tijmen/csc321/slides/lecture_slides_lec6.pdf", "posts/images/Neural Networks for Machine Learning.png", new Date(2024, 5, 25)),
