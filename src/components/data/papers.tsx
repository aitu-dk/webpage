...
const papers = [
    ...
    new Paper("Emerging Properties in Self-Supervised Vision Transformers", ["Mathilde Caron", "Hugo Touvron", "Ishan Misra", "Hervé Jégou", "Julien Mairal", "Piotr Bojanowski", "Armand Joulin"], "https://arxiv.org/pdf/2104.14294.pdf", "posts/images/Emerging Properties in Self-Supervised Vision Transformers.png", new Date(2024, 4, 7)),
    new Paper("Vision Transformers Need Registers", ["Timothée Darcet", "Maxime Oquab", "Julien Mairal", "Piotr Bojanowski"], "https://arxiv.org/pdf/2309.16588.pdf", "posts/images/Vision Transformers Need Registers.png", new Date(2024, 4, 7)),
    ...
    new Paper("What do Self Supervised Vision Transformers Learn?", ["Namuk Park", "Wonjae Kim", "Byeongho Heo", "Taekyung Kim", "Sangdoo Yun"], "https://arxiv.org/pdf/2305.00729.pdf", "posts/images/What do Self Supervised Vision Transformers Learn.png", new Date(2024, 4, 21)),

    new Paper("Revealing the Dark Secrets of Masked Image Modeling", ["Zhenda Xie", "Zigang Geng", "Jingcheng Hu", "Zheng Zhang", "Han Hu", "Yue Cao"], "https://arxiv.org/abs/2205.13543", "posts/images/Revealing the Dark Secrets of Masked Image Modeling.png", new Date(2024, 5, 4)),
    new Paper("Stochastic Gradient Descend", ["appliedprobability"], "https://appliedprobability.blog/2019/01/26/robbins-munro-2/", "posts/images/SGD.png", new Date(2024, 5, 4)),

    new Paper("Adding Gradient Noise Improves Learning for Very Deep Networks", ["Arvind Neelakantan", "Luke Vilnis", "Quoc V. Le", "Ilya Sutskever", "Lukasz Kaiser", "Karol Kurach", "James Martens"], "https://arxiv.org/pdf/1511.06807.pdf", "posts/images/Added Gradient Noise.png", new Date(2024, 5, 18)),
    new Paper("On the importance of initialization and momentum in deep learning", ["Ilya Sutskever", "James Martens", "George Dahl", "Geoffrey Hinton"], "https://proceedings.mlr.press/v28/sutskever13.html", "posts/images/On the importance of initialization and momentum in deep learning.png", new Date(2024, 5, 18)),

    new Paper("RMSProp", ["Geoffrey Hinton", "Nitish Srivastava", "Kevin Swersky"], "https://www.cs.toronto.edu/~tijmen/csc321/slides/lecture_slides_lec6.pdf", "posts/images/Neural Networks for Machine Learning.png", new Date(2024, 6, 2)),
    new Paper("Adam: A Method for Stochastic Optimization", ["Diederik P. Kingma", "Jimmy Ba"], "https://arxiv.org/abs/1412.6980", "posts/images/Adam A Method for Stochastic Optimization.png", new Date(2024, 6, 2)),

    new Paper("Symbolic Discovery of Optimization Algorithms", ["Xiangning Chen", "Chen Liang", "Da Huang", "Esteban Real", "Kaiyuan Wang", "Yao Liu", "Hieu Pham", "Xuanyi Dong", "Thang Luong", "Cho-Jui Hsieh", "Yifeng Lu", "Quoc V. Le"], "https://arxiv.org/abs/2302.06675", "posts/images/Symbolic Discovery of Optimization Algorithms.png", new Date(2024, 6, 16)),
    new Paper("VeLO: Training Versatile Learned Optimizers by Scaling Up", ["Luke Metz", "James Harrison", "C. Daniel Freeman", "Amil Merchant", "Lucas Beyer", "James Bradbury", "Naman Agrawal", "Ben Poole", "Igor Mordatch", "Adam Roberts", "Jascha Sohl-Dickstein"], "https://arxiv.org/abs/2211.09760", "posts/images/VeLO Training Versatile Learned Optimizers by Scaling Up.png", new Date(2024, 6, 16)),
]
